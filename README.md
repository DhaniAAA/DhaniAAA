...
### 🧐 Who am I?
Saya [Pekerjaan/Status] yang suka memecahkan masalah dengan kode. Selain coding, saya juga suka bermain game dan [Hobi Lain].

- 🔭 **Current Project:** Membangun [Nama Aplikasi]
- ⚡ **Fun Fact:** Saya bisa mengetik [X] kata per menit!

### 💻 Arsenal
| Frontend | Backend | Tools |
| :---: | :---: | :---: |
| Next.js | Node.js / Supabase | VS Code |
